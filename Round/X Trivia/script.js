...
const questions = [
    ...
    },
    {
      ...
      choices: ["Michel-Ange", "Léonard de Vinci", "Pablo Picasso", "Vincent van Gogh"],
      correct: 1
    },
    {
    ...
    },
    {
      ...
      choices: ["Désert de Gobi", "Désert du Sahara", "Désert de l'Antarctique", "Désert d'Arabie"],
      correct: 2
    },
    {
...
function getRandomQuestion() {
  ...
  function displayQuestion() {
    ...
    questionObj.choices.forEach((choice, index) => {
        ...
        radioInput.addEventListener('change', () => isCorrect(index, questionObj.correct));
